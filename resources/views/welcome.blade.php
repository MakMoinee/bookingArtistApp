...
<head>
    <meta charset="utf-8">
    <link rel="icon" href="/storage/images/logo.svg" type="image/x-icon">
...
<body style="background: #afafafc5;">
    <header style="background: #afafafc5;padding:15px;">
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background: transparent !important;">
            <div class="container-fluid">
                <a class="navbar-brand" href="#" style="font-family: 'Roboto',sans-serif;">Bukidnon <span
                        style="margin-top: -20px;"><br>Groove</span></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" style="background: #919090c5">
    ...
    <section style="background: #afafafc5;width:100%;height: 500px;">
        <div class="container">
            <div class="row">
